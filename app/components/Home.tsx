...
const HomePage = () => {
  ...
  return (
    <div className="md:flex md:gap-10 justify-between">
      <div className="flex md:flex-col justify-start md:gap-10 sm:gap-4 sm:items-center">
        <p className=" sm:text-[1rem] md:text-[2rem] font-[700] 2xl:text-[4rem] font-sans">
        ...
        <div className="md:border md:rounded-[30px] md:h-[60px] sm:h-[12px] bg-white   outline-[#cb7529] flex justify-between px-5 items-center">
          ...
          <CustomButton
            ...
            name={"Get a Quote"}
            className={
              "sm:h-[2rem] sm:rounded-[10px] sm:text-[13px] md:h-[3rem] bg-[#cb7529] md:rounded-[30px] sm:w-[8rem] md:w-[10rem] 2xl:w-[15rem] text-white"
            }
          />
        </div>
      </div>
